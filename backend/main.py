...
from routers import quota, ai_search, price, auth, quota_import, price_import, data_report, project, devlog
...
app.include_router(devlog.router, prefix=settings.API_V1_PREFIX)
